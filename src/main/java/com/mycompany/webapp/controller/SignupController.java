...
public class SignupController {
	...
	public String regist(@ModelAttribute("creatememberdto") MemberDto member, Model model,
	...
	public void nicknamecheck(String mnicknamecheck, @ModelAttribute("creatememberdto") MemberDto member, Model model,
	...
	public String success(@ModelAttribute("creatememberdto") MemberDto member, Model model,
			SessionStatus sessionStatus) {
		model.addAttribute("member", member);
		sessionStatus.setComplete();
