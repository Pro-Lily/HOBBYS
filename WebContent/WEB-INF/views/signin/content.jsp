					...
					<!-- 이메일 입력 & 비밀번호 입력 시작 -->
						<div class="input-group mb-10" style="width: 100%;">
         							...
         							placeholder='  이메일을 입력하세요' onfocus="this.placeholder = ''" onblur="this.placeholder = '  이메일을 입력하세요'" 
         								style="height:45px; width:100%; font-size:16px;">
						</div>
						...
						<div class="button-group-area mt-40" style="font-size: 20px;">
							<input class="genric-btn primary circle" type="submit" name="submit" value="SIGN IN" style="width: 100%;">
