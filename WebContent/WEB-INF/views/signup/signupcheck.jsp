	...
	<p></p>
		 <div class="container">
		 	...
		 	<div class="row">
		 		...
		 		<h3 class="text-heading" style="font-size: 30px; display: inline;">회원가입 여부 안내</h3>
		 			<p></p>
					<p>기존 회원가입 정보와 일치하는 정보를 입력하셔야 회원가입 여부를 정확하게  확인하실 수 있습니다.</p>
					<p style="color: orange;">입력하신 정보는 회원가입 여부에만 사용되며 저장되지 않습니다.</p>	
					...
					<!-- 이메일 입력 & 비밀번호 입력 시작 -->
						...
						<div class="button-group-area mt-40" style="font-size: 20px;">
							<input type="submit" class="genric-btn primary circle" style="width: 100%;" value="가입 여부 확인"/>
