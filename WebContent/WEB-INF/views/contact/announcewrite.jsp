...
<hr style="margin-top:12px;">
    <form class="form-contact">
	    ...
	    <div class="row">
	         ...
	         <div class="col-12">
	             <div class="form-group">
	                 <textarea name="acontent" id="acontent" style="width: 100%; height: 100px;" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Content'" placeholder=" Enter Content"></textarea>
	             </div>
	        ...
	        <div class="col-sm-12">
	            <a style="width: 100%" href="javascript:allannouncelist()" class="button button-contactForm boxed-btn">BACK</a>
	        </div>
        <div class="col-sm-12">
